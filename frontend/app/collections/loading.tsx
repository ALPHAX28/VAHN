...
export default function CollectionsLoading() {
  return (
    <div style={{ background: '#ffffff', minHeight: '100vh', width: '100%', overflow: 'hidden' }}>
      ...
      {/* ── Dark Collections Header Skeleton ── */}
      <div
        style={{
          background: '#0e0e14',
      ...
      >
        <div className="vahn-shimmer-dark" style={{ width: '120px', height: '22px', borderRadius: '12px' }} />
        <div className="vahn-shimmer-dark" style={{ width: 'clamp(200px, 40vw, 340px)', height: '40px', borderRadius: '4px' }} />
        <div className="vahn-shimmer-dark" style={{ width: 'clamp(240px, 50vw, 420px)', height: '16px', borderRadius: '3px' }} />
      </div>
        ...
        >
          {[1, 2, 3].map((i) => (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              />
              <div className="vahn-shimmer-light" style={{ width: '60%', height: '22px', borderRadius: '2px' }} />
              <div className="vahn-shimmer-light" style={{ width: '85%', height: '14px', borderRadius: '2px' }} />
            </div>
          ))}
        </div>
      </div>
