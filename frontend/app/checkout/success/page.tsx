...
import { AlertCircleIcon, CheckIcon, ShoppingBagIcon, TruckIcon } from '@/components/icons/Icons';
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: '0.88rem', color: '#666', margin: '0 0 16px', lineHeight: 1.5 }}>
          Your payment was received and your order is confirmed. Our team has begun preparing your
          gear for dispatch.
        </p>
        ...
        >
          ...
          <strong style={{ fontSize: '1rem', letterSpacing: '0.04em', color: '#000' }}>
            {orderId}
          </strong>
          <button
                ...
                return (
                  <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        {item.product_title || item.productTitle || 'Product'}
                      </div>
                      <div style={{ fontSize: '0.75rem', color: '#666' }}>
                        {item.variant_title || item.variantTitle || 'Standard'} • Qty:{' '}
                        {item.quantity}
                      </div>
                    </div>
                    ...
                    <div style={{ fontWeight: 800, fontSize: '0.88rem', color: '#000' }}>
                      ...
                      {(
                        (item.price_amount ??
                          (item.price?.amount ? parseFloat(item.price.amount) : 0)) * item.quantity
...
export default function OrderSuccessPage() {
  return (
    <Suspense
      fallback={
        <div style={{ textAlign: 'center', padding: '80px 20px' }}>Loading Order Summary...</div>
      }
    >
      <OrderSuccessContent />
    </Suspense>
