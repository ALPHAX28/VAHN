    ...
    <div className="admin-page">
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">{counts.all} total customer inquiries & messages</p>
        </div>
      </div>
      ...
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: selectedMessage ? '1fr 450px' : '1fr',
          gap: '24px',
        }}
      >
        {/* Left: Messages Table */}
        ...
        >
          {loading ? (
            ...
            <div style={{ padding: '64px 24px', textAlign: 'center', color: '#888' }}>
              <p style={{ margin: '0 0 8px', fontWeight: 600, fontSize: '1rem' }}>
                No inquiries found
              </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '14px 16px', maxWidth: '260px' }}>
                          <span style={{ fontWeight: 600, color: '#374151', display: 'block' }}>
                            {msg.subject}
                          </span>
                          <span
                            style={{
                        ...
                        <td
                          style={{
                            padding: '14px 16px',
                            color: msg.order_number ? '#4232d9' : '#9ca3af',
                          }}
                        >
                          {msg.order_number || '—'}
                        </td>
                        ...
                        <td
                          style={{ padding: '14px 16px', color: '#6b7280', whiteSpace: 'nowrap' }}
                        >
            ...
            >
              <div>
                ...
                <a
                  ...
                  style={{ color: '#4232d9', textDecoration: 'underline', fontWeight: 600 }}
                >
              ...
              {selectedMessage.phone && (
                <div>
                  ...
                  <a
                    href={`tel:${selectedMessage.country_code}${selectedMessage.phone}`}
