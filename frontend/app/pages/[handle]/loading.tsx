...
export default function StaticPageLoading() {
  return (
    <div style={{ background: '#ffffff', minHeight: '80vh', width: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px clamp(16px, 4vw, 40px) 100px' }}>
        <div className="vahn-shimmer-light" style={{ width: 'clamp(200px, 50vw, 360px)', height: '40px', borderRadius: '4px', marginBottom: '24px' }} />

        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div className="vahn-shimmer-light" style={{ width: '100%', height: '16px', borderRadius: '2px' }} />
          <div className="vahn-shimmer-light" style={{ width: '95%', height: '16px', borderRadius: '2px' }} />
          <div className="vahn-shimmer-light" style={{ width: '90%', height: '16px', borderRadius: '2px' }} />
          <div className="vahn-shimmer-light" style={{ width: '70%', height: '16px', borderRadius: '2px', marginBottom: '16px' }} />

          <div className="vahn-shimmer-light" style={{ width: '220px', height: '24px', borderRadius: '3px', marginTop: '12px', marginBottom: '8px' }} />
          <div className="vahn-shimmer-light" style={{ width: '100%', height: '16px', borderRadius: '2px' }} />
