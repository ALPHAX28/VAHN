          ...
          const content = (
            ...
            >
              ...
              {banner.link_text && (
                ...
                >
                  {banner.link_text}
                  <svg className="btn-checkout-arrow" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
